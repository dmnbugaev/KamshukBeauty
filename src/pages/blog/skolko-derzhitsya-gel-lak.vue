...
useHead({
  title: 'Сколько держится гель-лак и от чего зависит результат | Камшук Бьюти',
  meta: [
    { name: 'description', content: 'Узнайте, сколько в норме держится маникюр гель-лак, почему он отходит раньше срока и как продлить носку до 4 недель. Советы от мастера Камшук Бьюти.' },
  ...
  script: [{
    ...
    innerHTML: JSON.stringify({
      ...
      description: 'Разбираем, почему гель-лак держится у одних 4 недели, а у других — две, и как это исправить.',
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <header class="mb-12">
            ...
            <p class="body text-xl text-[#6B4F5A] leading-relaxed">
              Одним маникюр служит месяц, другим — две недели. Разбираемся, почему так бывает и что с этим делать.
            </p>
          </header>
          ...
          <div class="prose-beauty space-y-8 body text-base text-[#424242] leading-relaxed">
            <section>
              <h2 class="headline text-2xl text-[#1A1A2E] mb-4">Нормальный срок носки гель-лака</h2>
              <p>В норме качественный гель-лак, нанесённый профессиональным мастером, держится <strong>3–4 недели</strong>. Именно за это время ноготь отрастает настолько, что требует коррекции — ноготок у кутикулы вырастает, и маникюр смотрится менее свежо.</p>
              <p>Наши гостьи в среднем приходят на маникюр раз в месяц — и покрытие ни разу не подводит. Если ваш гель-лак держится меньше двух недель, на то есть причины.</p>
            </section>
            ...
            <section>
              <h2 class="headline text-2xl text-[#1A1A2E] mb-4">Как продлить жизнь маникюру: 5 советов</h2>
              <ol class="space-y-3 list-none">
                <li v-for="(tip, i) in [
                  'Наносите масло для кутикулы ежедневно — это питает кожу вокруг ногтя и предотвращает отслоение покрытия у краёв.',
                  'Работайте с бытовой химией только в перчатках.',
                  'Не используйте ногти как инструмент — не открывайте ими банки и упаковки.',
            ...
            <section>
              <h2 class="headline text-2xl text-[#1A1A2E] mb-4">Итого</h2>
              <p>Если ваш маникюр держится меньше трёх недель при соблюдении правил ухода, стоит проверить качество материалов и технику нанесения. Приходите к нам в студию — мастер оценит состояние ногтей и подберёт оптимальный тип покрытия именно для вас.</p>
            </section>
          </div>
          ...
          <div class="mt-16 glass-pink rounded-3xl p-6 sm:p-8 text-center">
            ...
            <p class="body text-sm text-[#6B4F5A] mb-6">Запишитесь в Камшук Бьюти — новым гостям скидка 20% на первый визит.</p>
