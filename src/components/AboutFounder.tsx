        ...
        <div className="grid lg:grid-cols-5 gap-16 items-center max-w-[1400px] mx-auto">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 body text-base text-[#424242] mb-12">
              ...
              <p>
                Я верю, что истинная красота начинается не только с уверенности в себе. Она идёт от сердца, когда человек светится изнутри - "сияет". Тогда-то, и происходят чудеса💫.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              },
              {
                ...
                text: 'Учитываем особенности и пожелания каждого гостя',
              },
              {
                title: 'Забота',
