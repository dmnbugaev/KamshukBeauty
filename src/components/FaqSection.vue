...
const faqs = [
  ...
  },
  {
    ...
    a: 'Да! До конца июля действует Радужное предложение: скидка 30% на все услуги студии. Предложение действует только на первый визит, скидки и акции не суммируются.',
  },
  {
